        ...
        <div class="login container">
          ...
          <form action="entrar.php" method="post" class="cadn container" autocomplete="off">
            ...
            <div class="cad form-group">
              ...
              <input name="email" type="email" class="form-control" id="eInputEmail" aria-describedby="emailHelp" placeholder="Enter email" style="display:none" required>
            </div>

            <div class="cad form-group">
              <h4 class="mano" for="InputPassword">Password</h4>
              <input name="senha" type="password" class="form-control" id="InputPassword" placeholder="Password" display="none" style="display:none" required>
            </div>
