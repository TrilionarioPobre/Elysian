        ...
        <div class="login container">
          ...
          <form action="cadastro.php" method="post" class="cadn">
            ...
            <div class="cad form-group">
              ...
              <input name="nome" type="text" class="form-control" id="InputUsername">
            </div>
            ...
            <div class="cad form-group">
              <h5 class="titulo" for="AltPassword">Confirmar senha</h5>
              <input name="senhaconfirmar" type="password" class="form-control" id="AltPassword">
            </div>
