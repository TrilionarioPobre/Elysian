    ...
    <header>
      ...
      <div class="login jumbotron jumbotron-fluid">
        <div class="login container">
          <h1 class="titulo text-center">Criar uma conta</h1>
          <form action="entrar.php" method="post" class="cadn container">
            ...
            <div class="cad form-group">
              ...
              <input name="email" type="email" class="form-control" id="eInputEmail" aria-describedby="emailHelp" placeholder="Enter email">
            </div>

            <div class="cad form-group">
              <h4 class="mano" for="InputPassword">Password</h4>
              <input name="senha" type="password" class="form-control" id="InputPassword" placeholder="Password">
            </div>
