...
<html lang="pt-br">
  ...
  <body>
    ...
    <div class="about container">
      <h3 class="sobre text-center">Sobre nós</h3>
      <div class="about-content text-center">
        <p>
        Elysian é pensado e feito para quebrar o status quo, nascendo do fogo
        ardente dos desenvolvedores de encontrar um solução para a grande
        falta de inglês do brasileiro médio, que o deixa amarrado ao mercado
        nacional, deixando-o para trás da concorrência, seu objetivo é simples
        mais claro, ENSINAR INGLÊS!
        </p>
        <p>
        Nosso próposito é elevar a qualidade de vida da sociedade através do
        conhecimento, permanece incontestável e se manterá assim!
        </p>
        <p>
        Não é apenas um jogo muito menos um mero projeto, é ELYSIAN, vindo e
        forjado do suor e dedicação de todos os envolvidos, estará HOJE,
