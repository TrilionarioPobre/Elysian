        ...
        <div class="login container">
          ...
          <form action="cadastro.php" method="post" class="cadn" autocomplete="off">
            ...
            <div class="cad form-group">
              ...
              <input name="nome" type="text" class="form-control" id="InputUsername" style="display:none" required>
            </div>
              <h5 class="titulo" name="email" for="InputEmail">Email</h5>
              <input name="email" type="email" class="form-control" id="InputEmail" style="display:none" required>
            </div>
            <div class="cad form-group">
              <h5 class="titulo" name="senha" for="InputPassword">Senha</h5>
              <input name="senha" type="password" class="form-control" id="InputPassword" style="display:none" required>
            </div>
